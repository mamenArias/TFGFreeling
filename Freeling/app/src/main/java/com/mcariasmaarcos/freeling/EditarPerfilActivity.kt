...
class EditarPerfilActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapterPron =
            EditarPerfilActivity.CustomArrayAdapter(this, R.layout.spinner_editar, pronombres)
        ...
        val adapterGen =
            EditarPerfilActivity.CustomArrayAdapter(this, R.layout.spinner_editar, generos)
        ...
        val adapterOrient =
            EditarPerfilActivity.CustomArrayAdapter(this, R.layout.spinner_editar, orientacion)
